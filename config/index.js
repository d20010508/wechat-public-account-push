export const config = {
  ...
  USERS: [
    {
      ...
      id: "o58ME6YOJ8XDERIJ-CRORdqf4FKc",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "8cG3B-DmlpcX3dJvObsDxug91qG_662tz62OyUa357g",
      // 所在省份
      province: "内蒙古",
      // 所在城市
      city: "呼和浩特",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "敏子", "year": "2000", "date": "10-29"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "节日", "name": "省考", "year": "2021", "date": "02-25"},
      ],
  ...
  CALLBACK_TEMPLATE_ID: "wJNQX6Em1dthfWotubkGKSvTfXSyBb9g3qC04-T73hU",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "o58ME6ceCKzdR-nAkQ3QSeKDBySk",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
